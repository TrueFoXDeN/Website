...
<div id="id_flugplan">
    <form id="id_form_plan">
        ...
        <fieldset id="id_fieldset_beforeflight">
            ...
            Delivery Freq: <input type="text" list="list_delivery_dep" id="id_delivery_freq" PLACEHOLDER="Select frequency...">
            Ground 1 Freq: <input list="list_ground_dep" type="text" id="id_gnd_1_freq_dep" PLACEHOLDER="Select frequency...">
            Ground 2 Freq: <input list="list_ground_dep" type="text" id="id_gnd_2_freq_dep" PLACEHOLDER="Select frequency...">
        ...
        <fieldset>
            ...
            <textarea id="id_route" name="name_route" placeholder="Route:" value="<?php echo @$Route;?>"></textarea>
        </fieldset>
        <br>
        <fieldset>
            <legend>Taxi</legend>
        ...
        <fieldset>
            ...
            Approach Freq: <input type="text" id="id_app_freq_arr" list="list_approach" placeholder="Select frequency...">
            Tower Freq: <input type="text" id="id_twr_freq_arr" list="list_tower_arr" placeholder="Select frequency...">
            Ground 1: <input type="text" id="id_gnd_1_freq_arr" list="list_ground_arr" placeholder="Select frequency...">
            Ground 2: <input type="text" id="id_gnd_2_freq_arr" list="list_ground_arr" placeholder="Select frequency...">
            <br><br>
